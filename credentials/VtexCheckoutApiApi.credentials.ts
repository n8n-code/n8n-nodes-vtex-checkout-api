...
export class VtexCheckoutApiApi implements ICredentialType {
	name = 'N8nDevVtexCheckoutApiApi';

	displayName = 'vtex-checkout-api API';

	icon: Icon = { light: 'file:../nodes/VtexCheckoutApi/vtex-checkout-api.svg', dark: 'file:../nodes/VtexCheckoutApi/vtex-checkout-api.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your vtex-checkout-api API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
